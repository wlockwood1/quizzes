...
MAJOR TO DO:
    -Deploy heroku site
    -Install devise and allow users to sign up. App will save all games they've played
    -Rspec tests
    -Prettier user interface

MINOR BUGS:
    -Categories dropdown in nav bar doesn't work after you start a game, even if you go back to main page. You have to refresh page for it to work again.
